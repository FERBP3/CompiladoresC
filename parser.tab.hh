  ...
  private:
    ...
    struct symbol_kind
    {
      enum symbol_kind_type
      {
        ...
        S_decl_var = 46,                         // decl_var
        S_47_2 = 47,                             // $@2
        S_list_var = 48,                         // list_var
        S_var = 49,                              // var
        S_type = 50,                             // type
        S_51_3 = 51,                             // $@3
        S_base = 52,                             // base
        S_arreglo = 53,                          // arreglo
        S_decl_struct = 54,                      // decl_struct
        S_55_4 = 55,                             // $@4
        S_56_5 = 56,                             // $@5
        S_body_struct = 57,                      // body_struct
        S_def_mem = 58,                          // def_mem
        S_functions = 59,                        // functions
        S_function = 60,                         // function
        S_61_6 = 61,                             // $@6
        S_list_args = 62,                        // list_args
        S_args = 63,                             // args
        S_arg = 64,                              // arg
        S_local_decls = 65,                      // local_decls
        S_local_decl = 66,                       // local_decl
        S_local_list = 67,                       // local_list
        S_local = 68,                            // local
        S_bloqueSentencias = 69,                 // bloqueSentencias
        S_sentencias = 70,                       // sentencias
        S_sentencia = 71,                        // sentencia
        S_sentReturn = 72,                       // sentReturn
        S_sentProc = 73,                         // sentProc
        S_list_params = 74,                      // list_params
        S_params = 75,                           // params
        S_param = 76,                            // param
        S_expresion = 77,                        // expresion
        S_complemento = 78,                      // complemento
        S_array = 79,                            // array
        S_condicion = 80,                        // condicion
        S_sentIf = 81,                           // sentIf
        S_sentElse = 82,                         // sentElse
        S_bloqueOSentencia = 83,                 // bloqueOSentencia
        S_sentWhile = 84,                        // sentWhile
        S_sentAsig = 85,                         // sentAsig
        S_left_part = 86,                        // left_part
        S_sentPutw = 87,                         // sentPutw
        S_sentPuts = 88,                         // sentPuts
        S_sentBreak = 89                         // sentBreak
      };
    };
...
switch (yykind)
    ...
    // Implementation of make_symbol for each symbol type.
      ...
      {
        return symbol_type (token::LCOR, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::RCOR, std::move (l));
      }
#else
      static
      symbol_type
      ...
      {
        return symbol_type (token::IFX, std::move (l));
      }
#else
      static
      symbol_type
